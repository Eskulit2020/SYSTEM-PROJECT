                            ...
                            <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                                <div class="item">
                                    <div class="item-title">
                                        <h2>Kambal Bunso Pizza</h2>
                                        <div class="border-bottom"></div>
                                        <span>499 Pesos</span>
                                    </div>
                                    <p>Choose a Flavor: Ham and Cheese, Vegetarian, Beef and Mushroom, and Cheese and Burger</p>
                                </div>
                            </li>
                            <li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                                <div class="item">
                                    <div class="item-title">
                                        <h2>Quatro Kantos Pizza</h2>
                                        <div class="border-bottom"></div>
                                        <span>999 Pesos</span>
                                    </div>
                                    <p>Choose a Flavor: Ham and Cheese, Vegetarian, Beef and Mushroom, and Cheese and Burger</p>
